...
class View:
    ...
    def start():
        while True:
            ...
            print("║ {:<2} - {:<54}║".format("10",      "Dar baixa em parcelas de um contrato"))
            print("║ {:<2} - {:<54}║".format("11",      "Registrar uso de contrato por dependente"))
            print("║ {:<2} - {:<54}║".format("12",      "Registrar uso de contrato por titular"))
